...
//                  (used by the editor's red-squiggle pipeline).
//
//   "parseView":   parse + map AST → ViewDef, return the runtime
//                  ViewDef plus diagnostics. The preview pane uses
//                  this so Langium stays out of the main bundle —
...
//
//   "parseDomain": parse + map AST → DomainDef. Used by the preview's
//                  auto-mock generator: rendering a view requires
//                  the bound domain's field shape to fabricate
